...
{
    public class MagazineTransactionsController : Controller
    {
        private VooraadModelsContainer db = new VooraadModelsContainer();

        // GET: MagazineTransactions
        ...
        // GET: MagazineTransactions/Details/5
        ...
        // GET: MagazineTransactions/Create
        ...
        // POST: MagazineTransactions/Create
        ...
        // GET: MagazineTransactions/Edit/5
        ...
        // POST: MagazineTransactions/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: MagazineTransactions/Delete/5
        ...
        // POST: MagazineTransactions/Delete/5
